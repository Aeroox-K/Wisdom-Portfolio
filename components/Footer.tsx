        ...
        <div className='flex w-full px-2 md:px-32 mt-16 md:flex-row flex-col justify-between items-center' >
            ...
            <div className='flex items-center pt-4 md:pt-0 md:gap-3 gap-6' >
                {socialMedia.map((profile) => (
                    <div className='w-10 h-10 cursor-pointer flex items-center justify-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black 300 ' >
